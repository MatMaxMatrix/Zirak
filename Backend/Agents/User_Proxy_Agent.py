...
class UserProxyAgent(UserProxyAgent):
    def __init__(self):
        super().__init__(
            ...
            description="""
            You are a user proxy agent that collects user queries. It can ask for the user's query or looping through the critical questions generated by the CriticalAnalysisAgent.
            """,
    ...
    def _always_true_trigger(self, sender):
        if self.context.get("requires_clarification", False) is False:
            return False
        else:
            return True
