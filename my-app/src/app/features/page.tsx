          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center flex-1">
              ...
              <div className="hidden md:flex md:items-center md:ml-8 space-x-4">
                ...
                <Link href="/features" className="text-white font-medium px-3 py-2 rounded-md text-sm">
                  Features
                </Link>
            ...
            {showMobileMenu && (
              <div className="md:hidden py-2 space-y-1">
                ...
                <Link href="/features" className="block text-white font-medium px-3 py-2 rounded-md text-base">
                  Features
                </Link>
