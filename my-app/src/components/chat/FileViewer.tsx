...
export function FileViewer({ selectedFile, content, filePath, onEdit }: FileViewerProps) {
  if (!selectedFile) {
    return (
  ...
  return (
    <>
      <div className="p-2 bg-[#1D1D1D] border-b border-[#2D2D2D] flex items-center">
        ...
        <span className="text-xs font-medium truncate text-gray-200">{filePath}</span>
      </div>
