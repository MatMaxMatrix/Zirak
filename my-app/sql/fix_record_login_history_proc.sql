...
-- Recreate the function with proper UUID handling (no TEXT casting)
...
DECLARE
  ...
  v_id INTEGER;
BEGIN
  -- Insert the record without explicit type casting
  INSERT INTO login_history (
    ...
    p_user_id,  -- No explicit cast needed anymore
    p_login_at,
    p_ip_address,
    p_device,
    p_location,
